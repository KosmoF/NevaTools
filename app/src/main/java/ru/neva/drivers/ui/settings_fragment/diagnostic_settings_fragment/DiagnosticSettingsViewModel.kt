...
@HiltViewModel
class DiagnosticSettingsViewModel @Inject constructor(
    ...
    fun setDiagnosticSettings(lkAddressVal: String,
            lkPortVal: Int,
            msgIntervalVal: Int,
            userCodeVal: String) : String
    {
        fptrHolder.fptr.setParam(IFptr.LIBFPTR_PARAM_SETTING_ID, 278)
        fptrHolder.fptr.setParam(IFptr.LIBFPTR_PARAM_SETTING_VALUE, lkAddressVal)
        ...
        fptrHolder.fptr.setParam(IFptr.LIBFPTR_PARAM_SETTING_VALUE, lkPortVal)
        fptrHolder.fptr.writeDeviceSetting()

        fptrHolder.fptr.setParam(IFptr.LIBFPTR_PARAM_SETTING_ID, 280)
        fptrHolder.fptr.setParam(IFptr.LIBFPTR_PARAM_SETTING_VALUE, msgIntervalVal)
        fptrHolder.fptr.writeDeviceSetting()

        fptrHolder.fptr.setParam(IFptr.LIBFPTR_PARAM_SETTING_ID, 283)
        fptrHolder.fptr.setParam(IFptr.LIBFPTR_PARAM_SETTING_VALUE, userCodeVal)
        fptrHolder.fptr.writeDeviceSetting()
    ...
    fun getDiagnosticSettings(): ArrayList<Any>{
